...
export function getLink() {
  ...
  return (
    "<https://www.roblox.com/games/start?placeId=2653064683&launchData=" +
    uuid +
    ">"
  );
}
  ...
  try {
    ...
    await dmChannel.send(
      getInteractionContent(
        ...
        "\n<@" +
          interaction.user.id +
          "> invited you to a duel for " +
          gameName +
          "!" +
          "\nClick to join the [reserved server](" +
          link +
          ").",
        false
      )
    ...
    await replyToInteraction(
      interaction,
      "Duel",
      "\n• Sorry, I couldn't send a DM to that user!",
      false
    );
    return;
  }
